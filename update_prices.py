...
# Nueva Expresion Textil via Yahoo Finance (NET.MC en Bolsa de Madrid)
try:
    r_net = requests.get('https://query1.finance.yahoo.com/v8/finance/chart/NET.MC?interval=1d&range=1d',
                     headers={'User-Agent': 'Mozilla/5.0'}, timeout=15)
    price_net = r_net.json()['chart']['result'][0]['meta']['regularMarketPrice']
    prices['ES0126962069'] = round(price_net, 5)
    print(f"  ✅ Nueva Expresion Textil: €{round(price_net, 5)}")
except Exception as e:
...
portfolio = [
    ...
    {'isin': 'IE00B4ND3602', 'qty': 33},
    {'isin': 'ES0112611001', 'qty': 14.525463},
    {'isin': 'US88160R1014', 'qty': 0.543552},
    {'isin': 'ES0126962069', 'qty': 3000},
]
fallback = {
    'ES0140794001': 13.77834, 'ES0112231016': 29.4927,
    'IE000ZYRH0Q7': 11.203,   'IE000QAZP7L2': 12.942,
    'ES0175902008': 20.2947,  'IE00B4ND3602': 75.785,
    'ES0112611001': 350.6535, 'US88160R1014': 340.05,
    'ES0126962069': 0.853,
}
