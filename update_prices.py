...
print("🔄 Actualizando precios Marco v10.5...\n")
...
portfolio = [
    ...
    {'isin': 'IE00B4ND3602', 'qty': 33},            # iShares Physical Gold
    {'isin': 'ES0112611001', 'qty': 14.525463},     # Azvalor Internacional FI
    {'isin': 'US88160R1014', 'qty': 0.543552},      # Tesla (Xetra EUR)
    {'isin': 'ES0126962069', 'qty': 4500},          # Nueva Expresion Textil
    {'isin': 'BTC',          'qty': 0.03049237},    # Bitcoin
]

fallback = {
    'ES0140794001': 13.8546,  'LU1598719752': 178.90,
    'IE000ZYRH0Q7': 11.416,   'IE000QAZP7L2': 13.65,
    'ES0175902008': 20.55209, 'IE00B4ND3602': 77.35,
    'ES0112611001': 346.7784, 'US88160R1014': 359.30,
    'ES0126962069': 0.885,    'BTC': 68976,
}
