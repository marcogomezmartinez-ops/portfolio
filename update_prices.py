...
print("🔄 Actualizando precios Marco v10.7...\n")

# ── FONDOS vía Morningstar ────────────────────────────────────────────────────
funds = [
    ('IE000QAZP7L2', 'iShares Emerging Markets'),
    ('IE000ZYRH0Q7', 'iShares Developed World'),
    # ('ES0140794001', 'Gamma Global FI'),  # VENDIDO 18/05/2026
    # ('ES0175902008', 'Sigma Internacional'),  # VENDIDO 19/05/2026
    ('ES0112611001', 'Azvalor Internacional FI'),
    ('LU1598719752', 'Cobas International Fund'),
    # ('IE000UL6CLP7', 'Global X Silver Miners'),  # fetched via Yahoo Finance below
...
# ── Global X Silver Miners UCITS vía Yahoo Finance (SLVRG.DE — EUR, Xetra) ───
try:
    r_silv = requests.get('https://query1.finance.yahoo.com/v8/finance/chart/SLVRG.DE?interval=1d&range=5d',
                     headers={'User-Agent': 'Mozilla/5.0'}, timeout=15)
    price_silv = r_silv.json()['chart']['result'][0]['meta']['regularMarketPrice']
    prices['IE000UL6CLP7'] = round(price_silv, 5)
    print(f"  ✅ Global X Silver Miners: €{round(price_silv, 5)}")
except Exception as e:
...
portfolio = [
    # {'isin': 'ES0140794001', 'qty': 0},   # Gamma vendido
    {'isin': 'LU1598719752', 'qty': 0.4752},         # Cobas International Fund
    {'isin': 'IE000ZYRH0Q7', 'qty': 38.38},          # iShares Developed World
    {'isin': 'IE000QAZP7L2', 'qty': 14.51},          # iShares Emerging Markets
    # {'isin': 'ES0175902008', 'qty': 0},   # Sigma vendido
    {'isin': 'IE00B43VDT70', 'qty': 80},            # Invesco Physical Silver
    {'isin': 'IE000UL6CLP7', 'qty': 159},           # Global X Silver Miners
    ...
    {'isin': 'BTC',          'qty': 0.00000804},    # Bitcoin (dust)
]

fallback = {
    'LU1598719752': 179.99,
    'IE000ZYRH0Q7': 11.557,   'IE000QAZP7L2': 13.336,
    'IE00B43VDT70': 62.0,   'IE000UL6CLP7': 35.585,
    'ES0112611001': 346.7784, 'US88160R1014': 385.95,
    'ES0126962069': 0.907,    'BTC': 66304,
}
