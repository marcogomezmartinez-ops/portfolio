...
funds = [
    ...
    # Nueva Expresion Textil se actualiza via Yahoo Finance NXT.MC
]
...
# Nueva Expresion Textil via Yahoo Finance (NXT.MC - Bolsa de Madrid)
try:
...
portfolio = [
    ...
    {'isin': 'ES0175902008', 'qty': 15.468617},
    {'isin': 'IE00B4ND3602', 'qty': 33},
    {'isin': 'ES0112611001', 'qty': 14.525463},
    {'isin': 'US88160R1014', 'qty': 0.543552},
    {'isin': 'ES0126962069', 'qty': 3000},
    {'isin': 'BTC',          'qty': 0.01453293},
]
fallback = {
    'ES0140794001': 13.81201, 'ES0112231016': 29.27249,
    'IE000ZYRH0Q7': 11.263,   'IE000QAZP7L2': 12.714,
    'ES0175902008': 20.36483, 'IE00B4ND3602': 75.22,
    'ES0112611001': 356.52419,'US88160R1014': 340.05,
    'ES0126962069': 0.845,    'BTC': 68634,
}
